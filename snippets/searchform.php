  ...
  <div class="row">
    <div class="col-lg-6 col-lg-offset-3 well">
      <form method="post" action="" class="form-horizontal">
        ...
        <div class="form-group">
          <div class="radio"><label class="radio-inline"><input type="radio" name="searchType" value="userName">Search Usernames</label></div>
          <div class="radio"><label class="radio-inline"><input type="radio" name="searchType" value="cluckText">Search Cluck Text</label></div>
        </div>
        <div class="form-group">
